...
bool PlayFabApiTest_0LoginWithEmail::Update()
{
    ...
    if (!clientAPI.IsValid())
    {
        ...
        clientAPI->LoginWithEmailAddress(request
            , PlayFab::FPlayFabClientAPI::FLoginWithEmailAddressDelegate::CreateRaw(this, &PlayFabApiTest_0LoginWithEmail::OnSuccess)
...
bool PlayFabApiTest_0LoginWithCustomID::Update()
{
    ...
    if (!clientAPI.IsValid())
    {
        ...
        clientAPI->LoginWithCustomID(request
            , PlayFab::FPlayFabClientAPI::FLoginWithCustomIDDelegate::CreateRaw(this, &PlayFabApiTest_0LoginWithCustomID::OnSuccess)
...
bool PlayFabApiTest_GetUserData::Update()
{
    ...
    if (!clientAPI.IsValid())
    {
        ...
        clientAPI->GetUserData(request
            , PlayFab::FPlayFabClientAPI::FGetUserDataDelegate::CreateRaw(this, &PlayFabApiTest_GetUserData::OnSuccess)
...
bool PlayFabApiTest_UpdateUserData::Update()
{
    ...
    if (!clientAPI.IsValid())
    {
        ...
        clientAPI->UpdateUserData(request
            , PlayFab::FPlayFabClientAPI::FUpdateUserDataDelegate::CreateRaw(this, &PlayFabApiTest_UpdateUserData::OnSuccess)
...
bool PlayFabApiTest_GetPlayerStatistics::Update()
{
    ...
    if (!clientAPI.IsValid())
    {
        ...
        clientAPI->GetPlayerStatistics(
            request,
            PlayFab::FPlayFabClientAPI::FGetPlayerStatisticsDelegate::CreateRaw(this, &PlayFabApiTest_GetPlayerStatistics::OnSuccess)
...
bool PlayFabApiTest_UpdatePlayerStatistics::Update()
{
    ...
    if (!clientAPI.IsValid())
    {
        ...
        clientAPI->UpdatePlayerStatistics(request
            , PlayFab::FPlayFabClientAPI::FUpdatePlayerStatisticsDelegate::CreateRaw(this, &PlayFabApiTest_UpdatePlayerStatistics::OnSuccess)
...
bool PlayFabApiTest_GetAllUsersCharacters::Update()
{
    ...
    if (!clientAPI.IsValid())
    {
        ...
        clientAPI->GetAllUsersCharacters(request
            , PlayFab::FPlayFabClientAPI::FGetAllUsersCharactersDelegate::CreateRaw(this, &PlayFabApiTest_GetAllUsersCharacters::OnSuccess)
...
bool PlayFabApiTest_GetLeaderboardC::Update()
{
    ...
    if (!clientAPI.IsValid())
    {
        ...
        clientAPI->GetLeaderboard(request
            , PlayFab::FPlayFabClientAPI::FGetLeaderboardDelegate::CreateRaw(this, &PlayFabApiTest_GetLeaderboardC::OnSuccess)
...
bool PlayFabApiTest_GetAccountInfo::Update()
{
    ...
    if (!clientAPI.IsValid())
    {
        ...
        clientAPI->GetAccountInfo(request
            , PlayFab::FPlayFabClientAPI::FGetAccountInfoDelegate::CreateRaw(this, &PlayFabApiTest_GetAccountInfo::OnSuccess)
...
bool PlayFabApiTest_ExecuteCloudScript::Update()
{
    ...
    if (!clientAPI.IsValid())
    {
        ...
        clientAPI->ExecuteCloudScript(request
            , PlayFab::FPlayFabClientAPI::FExecuteCloudScriptDelegate::CreateRaw(this, &PlayFabApiTest_ExecuteCloudScript::OnSuccess)
...
bool PlayFabApiTest_WriteEvent::Update()
{
    ...
    if (!clientAPI.IsValid())
    {
        ...
        clientAPI->WritePlayerEvent(request
            , PlayFab::FPlayFabClientAPI::FWritePlayerEventDelegate::CreateRaw(this, &PlayFabApiTest_WriteEvent::OnSuccess)
...
bool PlayFabApiTest_GetEntityToken::Update()
{
    ...
    if (!authenticationAPI.IsValid())
    {
        ...
        authenticationAPI->GetEntityToken(
            request,
            PlayFab::FPlayFabAuthenticationAPI::FGetEntityTokenDelegate::CreateRaw(this, &PlayFabApiTest_GetEntityToken::OnSuccess)
...
bool PlayFabApiTest_MultipleUsersWithStaticApis::Update()
{
    ...
    if (!clientAPI.IsValid())
    {
        ...
        clientAPI->LoginWithCustomID(user1LoginRequest
            , PlayFab::FPlayFabClientAPI::FLoginWithCustomIDDelegate::CreateRaw(this, &PlayFabApiTest_MultipleUsersWithStaticApis::OnUser1LoginSuccess)
        ...
        clientAPI->LoginWithCustomID(user2LoginRequest
            , PlayFab::FPlayFabClientAPI::FLoginWithCustomIDDelegate::CreateRaw(this, &PlayFabApiTest_MultipleUsersWithStaticApis::OnUser2LoginSuccess)
            , PlayFab::FPlayFabErrorDelegate::CreateRaw(this, &PlayFabApiTest_MultipleUsersWithStaticApis::OnError)
        );
    }
...
void PlayFabApiTest_MultipleUsersWithStaticApis::OnBothUsersLoggedIn()
{
    ...
    clientAPI->GetPlayerProfile(user1ProfileRequest
        , PlayFab::FPlayFabClientAPI::FGetPlayerProfileDelegate::CreateRaw(this, &PlayFabApiTest_MultipleUsersWithStaticApis::OnUser1GetProfileSuccess)
        , PlayFab::FPlayFabErrorDelegate::CreateRaw(this, &PlayFabApiTest_MultipleUsersWithStaticApis::OnError)
    );
    ...
    clientAPI->GetPlayerProfile(user2ProfileRequest
        , PlayFab::FPlayFabClientAPI::FGetPlayerProfileDelegate::CreateRaw(this, &PlayFabApiTest_MultipleUsersWithStaticApis::OnUser2GetProfileSuccess)
        , PlayFab::FPlayFabErrorDelegate::CreateRaw(this, &PlayFabApiTest_MultipleUsersWithStaticApis::OnError)
    );
}
