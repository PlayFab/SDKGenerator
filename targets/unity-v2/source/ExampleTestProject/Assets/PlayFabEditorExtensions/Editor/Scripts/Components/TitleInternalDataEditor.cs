...
namespace PlayFab.PfEditor
{
    public class TitleInternalDataEditor : UnityEditor.EditorWindow
    {
        ...
        //        EditorGUILayout.LabelField(string.Format("Testing: {0}", key), PlayFabEditorHelper.uiStyle.GetStyle("orTitle"), GUILayout.MinWidth(EditorGUIUtility.currentViewWidth));

        //    scrollPos = GUILayout.BeginScrollView(scrollPos, PlayFabEditorHelper.uiStyle.GetStyle("gpStyleGray1"));
        //    Value = EditorGUILayout.TextArea(Value, PlayFabEditorHelper.uiStyle.GetStyle("editTxt"));
        //    GUI.skin.settings.cursorColor = Color.black;
        //    GUI.SetNextControlName("TextAreaInternal");
        ...
        //        GUI.SetNextControlName("SaveButtonInternal");
