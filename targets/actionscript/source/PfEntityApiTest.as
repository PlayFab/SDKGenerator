package
{
    ...
    public class PfEntityApiTest extends Sprite
    {
        private var textField:TextField = new TextField();
        private var testSuite:PlayFabEntityApiTests;
        private var exitCode:int;

        public function PfEntityApiTest()
        {
        ...
        private function onInvoke(e:InvokeEvent):void
        {
            ...
            testSuite = new PlayFabEntityApiTests(titleDataFileName, reporters);
