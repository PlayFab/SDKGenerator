    ...
    if [ "$TestiPhone" = "true" ]; then
        ...
        pushd "${ProjRootPath}/${SdkName}_TC"
            ...
            pushd "$WORKSPACE/SDKGenerator/SDKBuildScripts"
                ...
                . ./unity_buildAppCenterTestIOS.sh "$ProjRootPath/${SdkName}_TC/testBuilds/PlayFabIOS" "$WORKSPACE/vso" 'git@ssh.dev.azure.com:v3/playfab/Playfab%20SDK%20Automation/UnitySDK_XCode_AppCenterBuild' $JOB_NAME init || exit 1
                if [[ $? -ne 0 ]]; then return 1; fi
