...
exports.MakeBp = function (api, apiOutputDir, subdir) {
...
function GenerateBpDataModels(api, apiOutputDir, subdir) {
    var sourceDir = __dirname;
...
function GenerateBpLibrary(api, apiOutputDir, subdir) {
    var sourceDir = __dirname;
