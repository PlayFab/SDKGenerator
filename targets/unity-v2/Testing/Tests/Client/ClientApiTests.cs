...
namespace PlayFab.UUnit
{
    public class ClientApiTests : UUnitTestCase
    {
        ...
        public async void WriteOneDSEventsAsync(UUnitTestContext testContext)
        {
            ...
            var writeTask = oneDSEventsApi.WriteTelemetryEventsAsync(request, null, new Dictionary<string, string>());
        ...
        private static void ContinueWithContext<T>(Task<PlayFabResult<T>> srcTask, UUnitTestContext testContext,
            Action<PlayFabResult<T>, UUnitTestContext, string> continueAction, bool expectSuccess, string failMessage,
            bool endTest) where T : PlayFabResultCommon
        {
