...
-- Create library
local lib = Library:new{ name='plugin.playfab.server', publisherId='com.playfab' }

-------------------------------------------------------------------------------
-- BEGIN (Insert your implementation starting here)
-------------------------------------------------------------------------------

local json = require("plugin.playfab.server.json")

local defaults = require("plugin.playfab.server.defaults")
