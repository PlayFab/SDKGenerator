...
exports.makeClientAPI2 = function (apis, sourceDir, apiOutputDir) {
    ...
    generateProject(apis, sourceDir, apiOutputDir, "Client", "ENABLE_PLAYFABENTITY_API", "PlayFabClientSDK");
}
...
exports.makeServerAPI = function (apis, sourceDir, apiOutputDir) {
    ...
    //    makeApi(apis[i], sourceDir, apiOutputDir);
    //generateSimpleFiles(apis, sourceDir, apiOutputDir);
    generateProject(apis, sourceDir, apiOutputDir, "Server", ";DISABLE_PLAYFABCLIENT_API;ENABLE_PLAYFABENTITY_API", "PlayFabServerSDK");
}
...
exports.makeCombinedAPI = function (apis, sourceDir, apiOutputDir) {
    ...
    //    makeApi(apis[i], sourceDir, apiOutputDir);
    //generateSimpleFiles(apis, sourceDir, apiOutputDir);
    generateProject(apis, sourceDir, apiOutputDir, "All", "ENABLE_PLAYFABADMIN_API;ENABLE_PLAYFABSERVER_API;ENABLE_PLAYFABMATCHMAKER_API;ENABLE_PLAYFABENTITY_API", "PlayFabSDK");
...
function generateProject(apis, sourceDir, apiOutputDir, libname, extraDefines, outputSubDir) {
    var projLocals = {
        apis: apis,
        libname: libname,
