...
var sdkGeneratorGlobals = {
    ...
    buildFlags: [],
    configDescription: "INVALID",
    docCache: {},
    config: null,
    pluginCache: {} // The collection of plugins required for SDK
};
var defaultConfigFilePath = "configuration"; // Relative path to Generate.js
var defaultConfigGitHubUrl = "https://raw.githubusercontent.com/PlayFab/API_Specs/master";
var defaultConfigPlayFabUrl = "https://www.playfabapi.com/apispec";
var pluginDescriptorFilename = "descriptor.json";
...
function downloadFromUrl(srcUrl, appendUrl, docCache, cacheKey, onEachComplete, optional) {
...
function prepareTargetOutputs(targetOutputPathList, config) {
    if (config) {
        targetOutputPathList.length = 0;
...
function generateModularSdks(buildIdentifier, targetOutputPathList, buildFlags, configDescription, config) {
...
function readPlugin(id, pluginsPath) {
 ...
 * */
function generateApiSummaryLines(apiElement, summaryParam, extraLines, linkToDocs, deprecationLabel) {
    var fullSummary;
