...
. RunUAT.sh BuildCookRun -clean -rocket -installed -nop4 -nocompile -project="/Users/toddbello/Documents/GitHub/sdks/UnrealMarketplacePlugin/4.21/ExampleProject/ExampleProject.uproject" -cook -stage -archive -archivedirectory="$archivePath" -package -clientconfig=Development -Platform="$targetPlatform" -compressed -CookAll -pak -prereqs -build -utf8output -editorrecompile
