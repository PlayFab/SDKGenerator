...
namespace PlayFab.UUnit
{
    public class PlayFabApiTest : UUnitTestCase
    {
        ...
        private void InvalidLoginContinued(PlayFabResult<LoginResult> loginResult, UUnitTestContext testContext, string failMessage)
        {
            ...
            testContext.True(loginResult.Error.GenerateErrorReprot().Contains("RequestId") && loginResult.Error.ErrorMessage.Contains("password"), loginResult.Error.ErrorMessage + ", for: "+ testTitleData.userEmail + ", on: " + PlayFabSettings.staticSettings.TitleId);
        }
