...
rmdir "%externalDir%/deps-xdk-release" /s /q

echo --- Building jsoncpp ---
pushd "%externalDir%/jsoncpp-xdk-build"
msbuild.exe lib_json.sln /nologo /t:Build /p:Configuration="Release" /p:Platform=Durango
...
xcopy "%externalDir%/deps" "%externalDir%/deps-xdk-release" /I /E /R /F /Y /H
popd
